...
// newList()
// Creates and returns a reference to a new empty List. 
List newList(void);
...
// moveNext()
// If cursor is defined and not at back, move cursor one step toward the back of L; if cursor is defined and at back, 
